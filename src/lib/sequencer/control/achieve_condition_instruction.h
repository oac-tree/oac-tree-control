...
#ifndef SUP_SEQUENCER_PLUGIN_CONTROL_ACHIEVE_CONDITION_INSTRUCTION_H_
#define SUP_SEQUENCER_PLUGIN_CONTROL_ACHIEVE_CONDITION_INSTRUCTION_H_
...
#endif  // SUP_SEQUENCER_PLUGIN_CONTROL_ACHIEVE_CONDITION_INSTRUCTION_H_
